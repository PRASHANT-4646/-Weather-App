        ...
        case 'rain':
            extraInfo.append(`
                <p class="text-info fw-bold">
                    <i class="fas fa-umbrella"></i> Rainy day, bring an umbrella!
                </p>
            `);
            break;
        case 'clear':
            extraInfo.append(`
                <p class="text-success fw-bold">
                    <i class="fas fa-sun"></i> Clear skies, enjoy the sunshine!
                </p>
            `);
            break;
        case 'clouds':
            extraInfo.append(`
                <p class="text-warning fw-bold">
                    <i class="fas fa-cloud"></i> Partly cloudy, a comfortable day.
                </p>
            `);
            break;
        default:
            extraInfo.append(`
                <p class="text-warning fw-bold">
                    <i class="fas fa-question"></i> Weather conditions may vary.
                </p>
            `);
    }
}
